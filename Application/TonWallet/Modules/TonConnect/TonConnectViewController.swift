...
//    private let wallet = WalletManager.shared.currentWallet
//
...
//
//        let codeBOC = try! wallet!.activeContract!.contract.stateInit.code!.toBoc()
//        let walletStateInit = codeBOC.base64EncodedString()
//        let publicKey = (wallet!.activeContract!.contract as! WalletV4R2).publicKey.hexString()
//
