...
public interface Mnemonic {
    public companion object {
        ...
        @JvmStatic
        public suspend fun doGenerate(): Array<String> {
            return generate()
        }
        ...
        public fun toSeed(mnemonic: Array<String>, password: String = ""): ByteArray =
            pbkdf2Sha512(
                toEntropy(mnemonic, password),
                DEFAULT_SALT.toByteArray(),
                DEFAULT_ITERATIONS
            ).sliceArray(0..31)
        ...
        public fun isPasswordSeed(entropy: ByteArray): Boolean =
            pbkdf2Sha512(
                entropy,
                DEFAULT_PASSWORD_SALT.toByteArray(),
                DEFAULT_PASSWORD_ITERATIONS
            ).first() == 1.toByte()

        public val DEFAULT_WORDLIST: Array<String>
            get() = arrayOf(
                "abandon",
                "ability",
                "able",
